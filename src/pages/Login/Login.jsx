...
const Login = () => {
  ...
  const sendOtp = async (e) => {
    ...
    try {
      ...
      const checkUserResponse = await fetch(`${process.env.VITE_API_BASE_URL}/auth/otp/check-user?phone=${encodeURIComponent(phoneNumber)}`, {
        method: 'GET',
        headers: {
      ...
      // Then send OTP
      const otpResponse = await fetch(`${process.env.VITE_API_BASE_URL}/auth/otp/send`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const verifyOtp = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.VITE_API_BASE_URL}/auth/otp/verify`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
